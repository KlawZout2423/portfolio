  ...
  return (
    <>
      ...
      <main className={styles.container}>
        ...
        {/* About Section / Core Engine */}
        <section id="about" className={styles.section}>
          <h2 className={styles.sectionTitle}>Core Engine: About Me</h2>
        ...
        {/* Skills Section / Blue Spotlight */}
        <section id="skills" className={styles.section}>
          <h2 className={styles.sectionTitle}>Blue Spotlight: Tech Stack</h2>
        ...
        {/* Projects Section / In Orbit */}
        <section id="projects" className={styles.section}>
          <h2 className={styles.sectionTitle}>In Orbit: Production Systems</h2>
        ...
        {/* Experience Section / Trajectory */}
        <section id="experience" className={styles.section}>
          <h2 className={styles.sectionTitle}>Trajectory: System Log</h2>
          <div className={styles.timeline}>
            ...
            <div className={styles.timelineItem}>
              <div className={styles.timelineHeader}>
                <h3 className={styles.timelineTitle}>Operations & Customer Service</h3>
                <span className={styles.timelineBadge}>Café Administrator</span>
              </div>
              <div className={styles.timelineRole}>Business Operations & Client Relations</div>
              <p className={styles.timelineDesc}>
                Managing day-to-day operations, scheduling backend structures, coordinating inventory databases, and ensuring 100% satisfaction rates across active client relationships.
              </p>
            </div>
